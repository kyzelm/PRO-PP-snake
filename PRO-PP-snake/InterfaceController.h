...
typedef struct InterfaceController {
	...
	int menuMode; /**< Menu state determining which menu is currently displayed (0 - main menu, 1 - level menu) */
	int menuCursor; /**< Menu cursor position (0 - first option, 1 - second option, 2 - third option) */
	char menu[2][3][12]; /**< Menu options table (2 menus, 3 options in each menu, maximum 12 characters in each option) */
} InterfaceController;
